...
// Deadline for a course is 12:00 the day before the course date.
...
function buildReportHtml(submissions, { title } = {}) {
  ...
  const generatedAt = fmtDateTimeHe(new Date().toISOString());
...
module.exports = { buildReportHtml, isLate, deadlineFor };
